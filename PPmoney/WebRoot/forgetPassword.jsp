...
<div class="regBackground" style="height:500px;">
	<div class="regBackgroundBox" style="height:450px;">
		<form action="forgetPassword.Action" method="post">
			<img src="images/logos_97589d4.png">
			<h1 style="text-align:center;font-size:20px;">PPmoney账户密码重置</h1>
			...
			<h2 style="text-align:center;">注册邮箱：<input style="width:200px;height:30px;" type="text" name="email"></h2>
