...
<script type="text/javascript">
	...
	$(function(){
			...
			"success":function(result){
						...
						str+="<tr><th>用户名</th><th>绑定卡号</th><th>手机</th><th>生日</th><th>邮箱</th><th>操作</th></tr>";
						for(var i=0;i<result.li.length;i++){
							str+="<tr><td class='first w4 c'>"+result.li[i].surName+"</td><td class='w1 c'>"+result.li[i].card+"</td><td class='w2 c'>"+result.li[i].phone+"</td><td class='w3 c'>"+result.li[i].birthday+"</td><td class='w4 c'>"+result.li[i].email+"</td><td class='w1 c'><a href='UserChange.Action?id="+result.li[i].id+"'>修改</a> <a class='manageDel' href='UserDelete1.Action?id="+result.li[i].id+"'>删除</a></td></tr>";							
						}	
							str+="</table>";
							$(".manage").html(str);
					}
