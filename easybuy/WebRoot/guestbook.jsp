...
<div id="main" class="wrap">
	...
	<div class="main">
		<div class="guestbook">
			...
			<ul>
				<c:forEach items="${li }" var="c">
					<li>
						<dl>
							<dt>${c.content }</dt>
							<dd class="author">网友：${c.name } <span class="timer">${c.createTime }</span></dd>
							<dd>${c.reply }</dd>
						</dl>
					</li>
				</c:forEach>
			...
			<div class="clear"></div>
			<div id="reply-box">
				<form action="insertComment.Action" method="post" id="guestBook">
					<table>
						<tr>
							<td class="field">昵称：</td>
							<td><input class="text" type="text" name="guestName" disabled="disabled" value="${sessionScope.userId }"/></td>
						</tr>						
						<tr>
