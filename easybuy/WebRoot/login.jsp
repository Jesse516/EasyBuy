			...
			<form id="loginForm" method="post" action="Login.Action" >
				<table>
					<tr>
						...
						<td>
                            <input class="text" type="text" id="userId" name="userId" /><p id="userId1"></p>
							<span></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<div id="password1">${msg}</div>
						</td>
					</tr>
					<tr>
					<td class="field">验证码：</td>
						<td>
                            <img src="AuthImg.Action" id="safeCode"/><a id="changeCode" href="javascript:document.getElementById('safeCode').src='AuthImg.Action?rnd='+Math.random();">看不清，换一张</a><br>
	                        <input type="text" name="code" id="code"><div class="mess"></div>
							<div id="code1"></div>
						</td>
					</tr>
					<tr>
