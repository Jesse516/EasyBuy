...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改商品</h2>
		<div class="manage">
			<form action="ProductUpdate.Action?id=${requestScope.p.id }" method="post" enctype="multipart/form-data">
				<table class="form">
					<tr>
						<td class="field">商品名称(*)：</td>
						<td><input type="text" class="text" name="productName" value="${requestScope.p.name }" /></td>
					</tr>
                    <tr>
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice" value="${requestScope.p.price }"/> 元</td>
					</tr>
					
					<tr>
						<td class="field">库存(*)：</td>
						<td><input type="text" class="text tiny" name="productNumber" value="${requestScope.p.amount }"/></td>
					</tr>
					<tr>
