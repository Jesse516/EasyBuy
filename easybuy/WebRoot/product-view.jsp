...
<div id="main" class="wrap">
	...
	<div id="product" class="main">
		<h1>${product.name }</h1>
		<div class="infos">
			<div class="thumb"><img src="images/${product.src }" width="110" height="106" /></div>
			<div class="buy">
				商城价：<span class="price">￥${product.price }</span><br /><!-- shopping.jsp -->
				库　存：有货
			  <div class="button"><input type="button" name="button" value="" onclick="location.href ='AddShopCart.Action?id=${product.id }'" /><a href="AddShopCart.Action?id=${product.id }">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
