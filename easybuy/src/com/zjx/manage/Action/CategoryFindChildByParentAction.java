...
public class CategoryFindChildByParentAction extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CategoryFindChildByParentAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(p!=null){
			...
			li=csi.findChildByParent(parentId);
			String str = JSONArray.toJSONString(li);
			out.print(str);
		}
